...
const KanbanContainerCard = () => <div className=" flex md:w-full min-[320px]:my-4 min-[320px]:w-full min-[320px]:p-0 min-[320px]:m-0 flex-col rounded border-2 border-black m-2 hover:mx-0 cursor-pointer"  draggable onDragCapture={(e)=>console.log(e)} >
  ...
  <div className='bg-blue-200 text-lg'><p className='m-2'>Internet Caindo e voltando a cada 5 min...</p>
