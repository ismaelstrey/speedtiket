...
const KanbanColumn = (props) => <div className={`box-border flex w-full  min-[320px]:m-0 min-[320px]:p-0 flex-col md:w-full sm:m-0 md:m-0 lg:m-2 rounded-sm border-2 rounded-t-xl ${props.bordeColor}`} onDragEndCapture={(e)=> console.log(e)}>
