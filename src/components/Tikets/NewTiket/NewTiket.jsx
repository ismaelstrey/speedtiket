...
const NewTiket = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(loginUser)} className=" flex justify-center content-center items-center">
...
<div className="flex w-full  p-4 content-center items-start justify-start flex-1">
  ...
  <select className="bg-slate-100 flex  border-b-2 border-solid border-black select-none outline-none focus:outline-0 ">
...
<div className="flex p-4 w-full ">
  ...
  <input  {...register("name", { required: true })} className="bg-slate-100 flex flex-1  border-b-2 border-solid border-black select-none outline-none focus:outline-0 " />
...
<div className="flex w-full  p-4 content-center items-start justify-start flex-1">
  ...
  <select className="bg-slate-100 flex flex-1  border-b-2 border-solid border-black select-none outline-none focus:outline-0 ">
    <option value="fisico">Fisico</option>
    <option value="juridico" selected>Juridico</option>
    <option value="" selected></option>
  </select>
...
<textarea  {...register("name", { required: true })} className="bg-slate-100 flex w-full border-2 border-solid border-black select-none outline-none focus:outline-0 h-full " />
{errors.name && <span>Nome</span>}
</div>
