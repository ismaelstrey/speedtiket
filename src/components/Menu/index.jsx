...
<div>
  ...
  {abrirEmpresa && <NovaEmpresa />}
   ...
   <span className="bg-green-600 p-2 rounded-full fixed bottom-10 right-20 hover:border-2 hover: border-white cursor-pointer" onClick={()=>setAbrirEmpresa(!abrirEmpresa)}><IoIosAddCircle/></span>
    <span className="bg-blue-400 p-2 rounded-full fixed bottom-20 right-10 hover:border-2 hover: border-white cursor-pointer aria-[title]:text-xs" title="Novo ticket" onClick={()=>setAbrirTiket(!abrirTiket)}><GrTicket/></span>   
