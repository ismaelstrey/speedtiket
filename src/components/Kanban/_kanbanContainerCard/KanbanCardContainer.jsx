...
const KanbanContainerCard =() =><div className="flex w-full min-[320px]:w-screen min-[320px]:p-0 min-[320px]:m-0 flex-col rounded border-2 border-black m-2 hover:mx-0 cursor-pointer">
